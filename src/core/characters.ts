...
export interface CharacterDef {
  ...
  dashCooldown: number
  /** 패시브 이름·설명. 설명에는 **사용자가 알 수 없는 수치(px·%·초)를 쓰지 않는다** — 글 그대로 받아들일 말로 (2026-09-06) */
  passiveName: string
  passiveDesc: string
  /** HUD·배너·이펙트에 쓰는 테마 색 */
  bodyColor: number
...
export const CHARACTERS: Record<CharacterId, CharacterDef> = {
  cheolmyeon: {
    ...
    passiveName: '차돌', passiveDesc: '가장 튼튼한 몸. 기관총을 퍼부으면서 맞아 준다.',
  ...
  chim: {
    ...
    passiveName: '침착', passiveDesc: '연사해도 총이 덜 흔들린다. 침착하니까.',
  ...
  dangun: {
    ...
    passiveName: '중계', passiveDesc: '가장 빠르다. 안 보이는 곳에서 누가 쏘면 그 자리가 잠깐 보인다.',
  ...
  magic: {
    ...
    passiveName: '진료', passiveDesc: '두꺼운 체력. 잠시 안 맞고 버티면 체력이 천천히 찬다.',
  ...
  jupeol: {
    ...
    passiveName: '빛남', passiveDesc: '너무 빛나서 가까이 온 상대는 눈이 부셔 더 아프게 맞는다.',
  ...
  uwon: {
    ...
    passiveName: '연기', passiveDesc: '구르고 나서도 잠깐 무적. 황금 보호막이 보이는 동안은 안 맞는다.',
  ...
  giyeol: {
    ...
    prominence: 7,
    maxHp: 200, speed: 3.2, weapon: 'smg', dashCooldown: 55,
    passiveName: '뇌절', passiveDesc: '연달아 맞힐수록 점점 아프다. 빗나가면 조금 식는다.',
  ...
  pungwol: {
    ...
    passiveName: '바람', passiveDesc: '남들보다 훨씬 자주 구른다. 산탄총 들고 파고들기.',
  ...
  oknyang: {
    ...
    passiveName: '냉정', passiveDesc: '조준경을 들여다보면서도 평소처럼 걷는다.',
  ...
  tongdak: {
    ...
    passiveName: '치킨', passiveDesc: '한 명 잡을 때마다 최대 체력이 조금 늘고 체력도 조금 찬다. 죽으면 원래대로.',
  ...
  juwoojae: {
    ...
    passiveName: '런웨이', passiveDesc: '다리가 길어서 한 번 구르면 더 멀리 간다.',
  ...
  seungwoo: {
    ...
    prominence: 12,
    maxHp: 260, speed: 3.7, weapon: 'pan', dashCooldown: 20,
    passiveName: '방패', passiveDesc: '앞에서 오는 총알을 후라이팬으로 절반쯤 튕긴다. 기력이 있는 동안만.',
