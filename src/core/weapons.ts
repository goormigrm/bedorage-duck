...
export const WEAPONS: Record<WeaponId, WeaponDef> = {
  ...
  shotgun: {
    id: 'shotgun', name: '산탄총', damage: 11, pellets: 7, fireInterval: 45, auto: false,
    magSize: 6, reloadTicks: 150, spreadHip: deg(14), spreadAds: deg(9), recoil: deg(4),
    recoilRecover: deg(0.4), speed: 12, life: 28, moveMul: 0.9, length: 26, color: 0x8b5a2b,
  },
  sniper: {
