...
## 현재 상태 (2026-09-05 · v1.9.10 — 기능 개발 종료, 배포 준비)
...
| 무기 7종 | ✅ | 권총·SMG·**소총(피해 23·탄속 24)**·산탄총·**저격총(조준경 한 방 · 스침 10 · 개머리판 10 · 탄 6)**·**기관총(15)**·**후라이팬(45)**. 전부 꾹 = 연사 |
...
| 밸런스 | ✅ 계측 기반 → **오픈 베타** | **봇 난이도 '보통' 기준, 최종 수치는 5시드(`seeds=5`)**. v1.9.10 5시드 1100판: 철면덕 62.0 · 옥냥덕 60.0 · 통천덕 57.5 · 풍월덕 54.5 · 침착덕 51.5 · 기열덕 51.0 · 주펄덕 50.0 · 매직덕 43.5 · 우재덕 42.5 · 단군덕 39.5 · 우원덕 37.0. 승빠덕 제외(`tools/melee.ts`). **배포 뒤에는 플레이어 의견으로 맞춘다** |
...
| 우원덕·주펄덕·기열덕 패시브 | `state.ts UWON`(무적 18틱 — 24 면 60% 로 튄다) · `JUPEOL`(200px·1.35) · `GIYEOL`(6%·6중첩) | — |
...
- **오픈 베타 조정 기록**: 2026-09-05 승빠덕 하향(제보 "사람끼리는 아직 세다") — CHANGELOG v1.9.4. 2026-09-05 저격 개편(제보 "너무 어렵다": 조준경 한 방·스침 10·개머리판·탄 6) — v1.9.5. 2026-09-05 승빠덕 2차 하향(막기 25%·피해 45) — v1.9.6. 2026-09-05 풍월덕 구르기 기력 34 → 22(재사용만 짧아 실효가 없었다) — v1.9.7. 2026-09-05 계측 기준 보통 봇으로(v1.9.8) → 기관총 15·소총 23(v1.9.9) → 침착덕 탄퍼짐 55%(v1.9.10).
