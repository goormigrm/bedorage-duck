...
| 네트워크 | ✅ 탭 3개 검증 | 정원 2~4(방 만들 때 선택·게스트에게 전달), 호스트 방송이 정본, N인 락스텝, 리싱크, **게임 중 난입**, 나가면 3초 뒤 자리 비움, **혼자 남아도 30초 대기** |
...
tests/                   determinism · camera · perf · balance · records · autoaim · sandbag · block · medkit · stats · join · spectate (79개)
