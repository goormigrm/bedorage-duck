...
## 현재 상태 (2026-09-05 · v1.9.8 — 기능 개발 종료, 배포 준비)
...
| 무기 7종 | ✅ | 권총·SMG·**소총(피해 20·탄속 24)**·산탄총·**저격총(조준경 한 방 · 스침 10 · 개머리판 10 · 탄 6)**·기관총·**후라이팬(45)**. 전부 꾹 = 연사 |
...
| 밸런스 | ✅ 계측 기반 → **오픈 베타** | **봇 난이도 '보통' 기준**(2026-09-05 — 사람 실력이 보통과 비슷하다). 2시드 440판: 철면덕 76.3 · 옥냥덕 63.7 · 통천덕 60.0 · 주펄덕 57.5 · 단군덕 56.3 · 풍월덕 50.0 · 매직덕 47.5 · 우원덕 40.0 · 기열덕 37.5 · 우재덕 31.3 · 침착덕 28.7. 승빠덕 제외(`tools/melee.ts`). **배포 뒤에는 플레이어 의견으로 맞춘다** — 다이얼 표는 아래 "오픈 베타 운영" |
...
| 소총이 세다/약하다 | 피해 20 (`weapons.ts rifle`) — 탄속 24 는 유지 | 연사 간격 10 |
...
- **오픈 베타 조정 기록**: 2026-09-05 승빠덕 하향(제보 "사람끼리는 아직 세다") — CHANGELOG v1.9.4. 2026-09-05 저격 개편(제보 "너무 어렵다": 조준경 한 방·스침 10·개머리판·탄 6) — v1.9.5. 2026-09-05 승빠덕 2차 하향(막기 25%·피해 45) — v1.9.6. 2026-09-05 풍월덕 구르기 기력 34 → 22(재사용만 짧아 실효가 없었다) — v1.9.7.
