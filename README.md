...
**v1.3** (2026-09-06) — 기능 개발 완료. 실제 플레이 피드백으로 다듬는 중.
...
- 혼자 하기(봇 1~3, 난이도 3단계) · 방 대전(최대 4명, 개인전/2v2 팀전). **끊겨도 45초 안에 돌아오면 이어서** 합니다.
...
| [docs/DESIGN.md](docs/DESIGN.md) | 설계서 v1.3 — 규칙·수치·구조·네트워크·결정론 규칙 전부 |
